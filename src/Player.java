...
public class Player {
    ...
    public Player() {
        objCincin = new Item("Cincin Emas", "Cincin emas bertuliskan suatu kalimat..", this.objGameInfo);
    ...
    // salah satu yg menggunakan: pintu untuk mengecek apakah player sudah punya
    // kunci
    ...
    public void pilihanAksi() {
        ...
        for (Item objItem : arrItem) {
            ...
            // ambil pilihannya
            ArrayList<String> arrPil = objItem.getArrAksi();
            // print pilihan
